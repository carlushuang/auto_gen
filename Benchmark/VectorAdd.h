...
/* solution控制                                                          */
/************************************************************************/
class VectAddSolution : public SolutionCtrlBase
{
private:
...
/* 问题控制                                                             */
/************************************************************************/
class VectAddProblem : public ProblemCtrlBase
{
public:
	VectAddProblem(std::string name) :ProblemCtrlBase(name)
	{
		Solution = new VectAddSolution();
	}

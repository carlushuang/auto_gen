...
#define RDC_ADD_TEST		1
	...
	class KernelWriterReducAdd :public KernelWriter
	{
	public:
	...
	protected:
		int N = 0;
		T_ExtReducAddProblemConfig * extProbCfg;	// 当前正在处理的问题扩展配置
		T_ExtReducAddSolutionConfig * extSolCfg;	// 当前正在处理的解决方案扩展配置

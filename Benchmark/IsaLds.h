...
/* solution控制                                                          */
/************************************************************************/
class LdsSolution : public SolutionCtrlBase
{
private:
...
/* 问题控制                                                             */
/************************************************************************/
class LdsProblem : public ProblemCtrlBase
{
public:
	LdsProblem(std::string name) :ProblemCtrlBase(name)
	{
		Solution = new LdsSolution();
	}

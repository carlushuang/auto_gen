...
/* solution控制                                                          */
/************************************************************************/
class ReducAddSolution : public SolutionCtrlBase
{
private:
...
/* 问题控制                                                             */
/************************************************************************/
class ReducAddProblem : public ProblemCtrlBase
{
public:
	ReducAddProblem(std::string name) :ProblemCtrlBase(name)
	{
		Solution = new ReducAddSolution();
	}

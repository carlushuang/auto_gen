...
/* solution控制                                                          */
/************************************************************************/
class SopSolution : public SolutionCtrlBase
{
private:
...
/* 问题控制                                                             */
/************************************************************************/
class SopProblem : public ProblemCtrlBase
{
public:
	SopProblem(std::string name):ProblemCtrlBase(name)
	{
		Solution = new SopSolution();
	}
